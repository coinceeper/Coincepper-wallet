...
class TokenMetadataService {
  ...
  static TokenMetadataService get instance => ServiceLocator.get<TokenMetadataService>();
  ...
  Future<int?> _erc20Decimals(String chain, String contract) async {
    ...
    try {
      ...
      SecureLog.w('TokenMetadata: on-chain decimals call failed', error: e);
      return null;
    } finally {
      client.dispose();
    }
  ...
  Future<int?> _trc20Decimals(String contract) async {
    try {
      ...
      SecureLog.w('TokenMetadata: TRC20 decimals call failed', error: e);
      return null;
    }
  }
  ...
  Future<int?> _readCache(String key) async {
    ...
    try {
      ...
      SecureLog.w('TokenMetadata: failed to decode cached decimals', error: e);
      return null;
    }
  }
