...
class TransactionNotificationReceiver implements ITransactionNotifier {
  TransactionNotificationReceiver();

  TransactionNotificationReceiver._internal();

  static TransactionNotificationReceiver get instance => ServiceLocator.get<TransactionNotificationReceiver>();
  ...
  void notifyTransactionConfirmed(String transactionId) {
    ...
    SecureLog.i('Transaction confirmed: $transactionId');
  }
  ...
  void notifyTransactionPending(String transactionId) {
    ...
    SecureLog.i('Transaction pending: $transactionId');
  }
  ...
  void notifyTransactionFailed(String transactionId, String error) {
    ...
    SecureLog.e('Transaction failed: $transactionId - $error');
  }
  ...
  void removePendingTransaction(String transactionId, BuildContext context) {
    ...
    SecureLog.i('Removed pending transaction: $transactionId');
  }
  ...
  void startListening(BuildContext context) {
    ...
    SecureLog.i('Transaction notification listener started');
  }
  ...
  void dispose() {
    ...
    SecureLog.i('Transaction notification listener stopped');
  }
}
