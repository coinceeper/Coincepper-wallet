...
class PermissionManager {
  ...
  static PermissionManager get instance => ServiceLocator.get<PermissionManager>();
  ...
  Future<bool> requestCameraPermission() async {
    try {
      ...
      SecureLog.e('Error requesting camera permission', error: e);
      return false;
    }
  }
  ...
  Future<bool> requestNotificationPermission() async {
    try {
      ...
      SecureLog.e('Error requesting notification permission', error: e);
      return false;
    }
  }
  ...
  Future<bool> requestBiometricPermission() async {
    try {
      ...
      SecureLog.e('Error requesting biometric permission', error: e);
      return false;
    }
  }
  ...
  Future<bool> requestStoragePermission() async {
    try {
      ...
      SecureLog.e('Error requesting storage permission', error: e);
      return false;
    }
  }
  ...
  Future<bool> requestMicrophonePermission() async {
    try {
      ...
      SecureLog.e('Error requesting microphone permission', error: e);
      return false;
    }
  }
  ...
  Future<bool> requestLocationPermission() async {
    try {
      ...
      SecureLog.e('Error requesting location permission', error: e);
      return false;
    }
  }
  ...
  Future<bool> requestBluetoothPermission() async {
    try {
      ...
      SecureLog.e('Error requesting bluetooth permission', error: e);
      return false;
    }
  }
  ...
  Future<void> openAppSettings() async {
    try {
      ...
      SecureLog.e('Error opening app settings', error: e);
    }
  }
  ...
  Future<bool> isBiometricSupported() async {
    try {
      ...
      SecureLog.e('Error checking biometric support', error: e);
      return false;
    }
  }
  ...
  Future<bool> isFaceIdSupported() async {
    try {
      ...
      SecureLog.e('Error checking Face ID support', error: e);
      return false;
    }
  }
  ...
  Future<Map<String, dynamic>> getDeviceInfo() async {
    try {
      ...
      SecureLog.e('Error getting device info', error: e);
      return {};
    }
  }
}
