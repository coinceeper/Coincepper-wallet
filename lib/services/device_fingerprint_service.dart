...
class DeviceFingerprintService {
  static DeviceFingerprintService get instance => ServiceLocator.get<DeviceFingerprintService>();
  ...
  Future<String> _generate() async {
    try {
      ...
      SecureLog.w('DeviceFingerprintService: generation failed, using random fallback', error: e);
