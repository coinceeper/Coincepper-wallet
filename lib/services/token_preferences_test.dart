...
void main() {
  group('TokenPreferences Tests', () {
    ...
    setUp(() {
      tokenPreferences = TokenPreferences(userId: 'test_user', walletName: 'test_wallet');
      testTokens = [
        const CryptoToken(
          name: 'Bitcoin',
          symbol: 'BTC',
    ...
    test('should generate correct token keys', () {
      ...
      const prefix = 'token_preferences_test_wallet_test_user_';
      expect(btcKey, '${prefix}BTC_Bitcoin_');
      expect(ethKey, '${prefix}ETH_Ethereum_');
      expect(usdtKey, '${prefix}USDT_Ethereum_0xdAC17F958D2ee523a2206206994597C13D831ec7');
    });
    ...
    test('should generate correct token keys from parameters', () {
      ...
      const prefix = 'token_preferences_test_wallet_test_user_';
      expect(key1, '${prefix}BTC_Bitcoin_');
      expect(key2, '${prefix}USDT_Ethereum_0x123');
    });
    ...
    test('should save and retrieve token order', () async {
      ...
      const prefix = 'token_preferences_test_wallet_test_user_';
      final order = ['${prefix}BTC_Bitcoin_', '${prefix}ETH_Ethereum_', '${prefix}USDT_Ethereum_0x123'];
    ...
    test('should clear all token preferences', () async {
      ...
      await tokenPreferences.enableToken(testTokens[0]);
      const prefix = 'token_preferences_test_wallet_test_user_';
      await tokenPreferences.saveTokenOrder(['${prefix}BTC_Bitcoin_']);
