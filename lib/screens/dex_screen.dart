...
class _CreatePoolScreen extends StatefulWidget {
  const _CreatePoolScreen({super.key});
...
/// Placeholder for the dex create pool screen
class DexCreatePoolScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: const Center(child: Text('Create Pool - Coming Soon')),
    );
  }
} 