...
class _AdminNotificationsScreenState extends State<AdminNotificationsScreen> {
  ...
  String _t(String key, String fallback) {
    try {
      ...
      SecureLog.w('AdminNotificationsScreen: translation "$key" failed, using fallback', error: e);
      return fallback;
    }
  }
...
class _NetworkTabState extends State<_NetworkTab> {
  ...
  Future<void> _sendNetworkStatus() async {
    ...
    final response =
        await ServiceLocator.get<ServiceProvider>().apiService.adminNotifyNetworkStatus(request);
  ...
  Future<void> _sendUpgrade() async {
    ...
    final response =
        await ServiceLocator.get<ServiceProvider>().apiService.adminNotifyNetworkUpgrade(request);
  ...
  Future<void> _sendPortfolioSummary() async {
    ...
    final response = await ServiceLocator.get<ServiceProvider>().apiService
...
class _EngagementTabState extends State<_EngagementTab> {
  ...
  final _newsUrlCtrl = TextEditingController(
      text: 'https://www.coingecko.com/en/news/pepe-listing');
  ...
  Future<void> _sendListing() async {
    ...
    final response =
        await ServiceLocator.get<ServiceProvider>().apiService.adminNotifyNewListing(request);
  ...
  Future<void> _sendNews() async {
    ...
    final response =
        await ServiceLocator.get<ServiceProvider>().apiService.adminSendBreakingNews(request);
  ...
  Future<void> _sendUpdate() async {
    ...
    final response =
        await ServiceLocator.get<ServiceProvider>().apiService.adminNotifyAppUpdate(request);
  ...
  Future<void> _sendReward() async {
    ...
    final response =
        await ServiceLocator.get<ServiceProvider>().apiService.adminSendReward(request);
...
class _BroadcastTabState extends State<_BroadcastTab> {
  ...
  Future<void> _sendBroadcast() async {
    ...
    final response =
        await ServiceLocator.get<ServiceProvider>().apiService.adminSendBroadcast(request);
