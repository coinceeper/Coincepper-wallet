...
class _HomeScreenState extends State<HomeScreen> with WidgetsBindingObserver {
  ...
  Future<void> _forceBitcoinEthereumPrices(PriceProvider priceProvider) async {
    try {
      ...
      if (btcPrice == null || ethPrice == null) {
        ...
        priceProvider.forceSetBitcoinEthereumPrices();  // ignore void result
  ...
  Future<void> _registerDeviceOnHome() async {
    try {
      ...
      final walletId = await SecureStorage.getWalletId();
    ...
    return WillPopScope(
        ...
        child: Consumer<AppProvider>(
          builder: (context, appProvider, _) {
                ...
                Timer(const Duration(seconds: 2), () async {
                  if (mounted) {
                    ...
                    if (!hasWallet) {
                      ...
                      context.go(RoutePaths.importCreate);
                    } else {
                    ...
                    child: Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 16),
                          Text(
                            _safeTranslate('verifying_wallet', 'Verifying wallet...'),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          style: const TextStyle(color: Color(0xFF666666), fontSize: 16, fontWeight: FontWeight.w500),
                        ),
                        const SizedBox(height: 8),
                        Text(
                          _safeTranslate('initializing_tokens', 'Initializing tokens and balances...'),
                          style: const TextStyle(color: Color(0xFF999999), fontSize: 12),
                        ),
                        // Add manual retry button after 8 seconds
                        FutureBuilder(
            ...
            // ⚡ ANDROID FIX: Wait for TokenProvider to be fully initialized (with timeout)
            if (tokenProvider.isLoading ||
              ...
              // Add timeout for TokenProvider initialization
              Timer(const Duration(seconds: 15), () {
                if (mounted && (tokenProvider.isLoading || tokenProvider.enabledTokens.isEmpty)) {
                  print('🚨 HomeScreen: TokenProvider initialization timeout, forcing refresh');
                  tokenProvider.forceRefresh().catchError((e) {
                  ...
                  child: Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        // Add manual retry button after 10 seconds
                        FutureBuilder(
                            ...
                            if (snapshot.connectionState == ConnectionState.done) {
                              return Column(
                                children: [
                                  ...
                                  FutureBuilder(
                                    future: Future.delayed(const Duration(seconds: 5)), // 15 seconds total
                                    builder: (context, snapshot) {
                                      if (snapshot.connectionState == ConnectionState.done) {
                                        return TextButton(
                                          onPressed: () {
                                            print('🚨 Emergency skip triggered - forcing navigation to home');
                                            // Force navigation even without full initialization
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            TextButton(
                              onPressed: () => context.push(RoutePaths.addToken),
                              ...
                              children: [
                                GestureDetector(
                                  onTap: () async {
                                    ...
                                    final result = await context.push(RoutePaths.addToken);
                          ...
                          children: [
                            ...
                            Consumer<PriceProvider>(
                              builder: (context, priceProvider, child) {
                                ...
                                final formattedValue = SharedPreferencesUtils.formatTokenValue(totalValue, currencySymbol);
                                return Text(
