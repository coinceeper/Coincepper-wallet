                  ...
                  _Section(
                    ...
                    children: [
                      _SettingItem(
                        ...
                        title: 'Test TspAgent (Go native)',
                        onTap: () async {
                          try {
                            final ver = await TspAgentChannel.version();
                            final health = await TspAgentChannel.healthJson();
                            final fp = await TspAgentChannel.fingerprint();
                            if (!context.mounted) {
                              return;
                            }
                            ScaffoldMessenger.of(context).showSnackBar(
