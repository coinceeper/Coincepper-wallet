...
public final class TspAgentBridge {
    ...
    /** فراخوانی شود بعد از ensureLoaded از Java thread (MainActivity) برای کش کردن کلاس WebView */
    public static native void cacheWebViewHost();

    /**
     * تنظیم پیکربندی WebView Pool (تعداد workers، auto-scaling، زمانبندی idle).
     * این تابع از Go agent (بعد از لود YAML) فراخوانی می‌شود تا pool
     * با تنظیمات agent.yml هماهنگ شود.
     *
     * @param configJson JSON: {"min_pool_size":4,"max_pool_size":-1,"idle_timeout_ms":60000,...}
     * @return JSON: {"success":true,"pool_size":...,"max_pool_size":...}
     */
    public static native String configureWebViewHost(String configJson);
